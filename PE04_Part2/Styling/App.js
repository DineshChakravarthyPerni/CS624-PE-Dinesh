...
const userImage = require('./assets/icons8-user-48.png');

const data = [{
    image: userImage,
    name: 'Dinesh Chakravarthy',
    occupation: 'React Native Developer',
    description: 'Dinesh is a really great Javascript developer. ' + 'He loves using JS to build React Native applications ' + 'for iOS and Android',
    showThumbnail: true,
  },
  {
    image: userImage,
